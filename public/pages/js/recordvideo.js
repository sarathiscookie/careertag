...
var mediaContainerFormat   = 'video';
recordingDIV.querySelector('button').onclick = function(e) {
    e.preventDefault();
    var button = this;
    ...
    if(recordingMedia === 'record-audio-plus-video') {
        ...
        button.mediaCapturedCallback = function() {
            ...
            if(webrtcDetectedBrowser !== 'firefox') { // opera or chrome etc.
                ...
                //http://recordrtc.org/
                /*videoRecorder.setRecordingDuration(5 * 1000).onRecordingStopped(function(url) {
...
/* View profile video from server*/
$( "#view-from-server" ).click(function(e){
    ...
    $.get("/profile/video", function(response){
        ...
        $( "#profile-video" ).html('<video width="400" height="240" controls><source src="'+response+'" type="video/webm"></video>');
    });
});
