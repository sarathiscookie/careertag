...
<head>
    ...
    <meta charset="utf-8"/>
    <title>careertag BETA - Kontakt</title>
...
<section class="jumbotron demo-custom-height xs-full-height bg-black" data-pages-bg-image="/assets-frontend/images/hero_4.jpg" style="height: 100%">
    <div class="container-xs-height full-height">
        <div class="col-xs-height col-middle text-left">
            <div class="container">
                <div class="col-sm-6">
                    <h1 class="light text-white"><b>careertag</b> BETA-Test</h1>
                    <h4 class="text-white">
                        Tobias Cvijic<br>
                        Kochstraße 37<br>
                        93077 Bad Abbach<br>
                        <br>
                        <a style="color: #FFF;" href="mailto:team@careertag.org">team@careertag.org</a><br>
                        0170 4149259
